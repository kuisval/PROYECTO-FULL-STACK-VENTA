                            ...
                            <div className="card" key={p.id}>
                                ...
                                <div className="card-body">
                                    <div className="dato">
                                        ...
                                        <span>{p.categorias?.nombre || '—'}</span>
                                    </div>
                                    <div className="dato">
                                        <span className="dato-label">Marca</span>
                                        <span>{p.marcas?.nombre || '—'}</span>
                                    </div>
                                    <div className="dato highlight">
                                        <span className="dato-label">Stock</span>
                                        <span>{p.stock ?? 0}</span>
                                    </div>
                                    <div className="dato">
                                        <span className="dato-label">Mínimo</span>
                                        <span>{p.stock_minimo ?? '—'}</span>
                                    </div>
                                    <div className="dato">
                                        <span className="dato-label">P. Compra</span>
                                        <span>${(p.precio_compra || 0).toFixed(2)}</span>
                                    </div>
                                    <div className="dato highlight">
                                        <span className="dato-label">P. Venta</span>
                                        <span>${(p.precio_venta || 0).toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>
                        );
