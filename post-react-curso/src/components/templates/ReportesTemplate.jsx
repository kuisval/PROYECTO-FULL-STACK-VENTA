...
const Container = styled.div`
    ...
    table {
        ...
        th { text-align: left; padding: 14px 16px; border-bottom: 2px solid ${({ theme }) => theme.color2}; font-weight: 700; color: ${({ theme }) => theme.colorSubtitle}; }
        td { padding: 12px 16px; border-bottom: 1px solid ${({ theme }) => theme.color2}; &.total { font-weight: 900; color: #53B257; } }
