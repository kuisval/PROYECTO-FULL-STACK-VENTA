...
const Container = styled.div`
    ...
    .producto-card {
        ...
        gap: 6px;
        &:hover { border-color: #1cb0f6; transform: translateY(-2px); }
        h4  { margin: 0; font-size: 14px; font-weight: 700; }
        .precio { font-size: 16px; font-weight: 900; color: #1cb0f6; }
        .stock  { font-size: 12px; color: ${({ theme }) => theme.colorSubtitle}; }
    }
    ...
    .carrito-item {
        ...
        .precio { font-weight: 700; color: #1cb0f6; }
        .controles {
            ...
            button {
                ...
                &:hover { background: #1cb0f6; color: #fff; border-color: #1cb0f6; }
            }
        }
    }
    ...
    .total {
        ...
        .monto { color: #1cb0f6; font-size: 24px; }
    }
