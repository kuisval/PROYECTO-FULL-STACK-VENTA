    ...
    return (
        <Container>
            ...
            <div className="form-inline">
                <input placeholder="Nombre de marca" value={nombre} onChange={e => setNombre(e.target.value)} onKeyDown={e => e.key === 'Enter' && guardar()} />
            ...
            {loading ? <p>Cargando...</p> : items.length === 0 ? <p className="empty">Sin marcas aún.</p> : (
                <div className="lista">
                    {items.map(item => (
